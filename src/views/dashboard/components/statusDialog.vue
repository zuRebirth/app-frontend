            ...
            <el-row :gutter="20">
                ...
                <el-col :span="8">
                    <el-form-item label="区域" prop="region">
                        <el-input v-model="ruleForm.region" :disabled="true" />
                    </el-form-item>
                </el-col>
                <el-col :span="3"></el-col>
                <el-col :span="8">
                    <el-form-item label="档口" prop="stall">
                        <el-input v-model="ruleForm.stall" :disabled="true" />
                    </el-form-item>
                </el-col>
            </el-row>
            <el-row :gutter="20">
                ...
                <el-col :span="8">
                    <el-form-item label="批次号">
                        <el-input v-model="ruleForm.batchNumber" :disabled="true" />
                    </el-form-item>
                </el-col>
                <el-col :span="3"></el-col>
                <el-col :span="8">
                    <el-form-item label="车牌号码">
                        <el-input v-model="ruleForm.numberPlate" :disabled="true" />
                    </el-form-item>
                </el-col>
            </el-row>
            <el-row :gutter="20">
                ...
                <el-col :span="8">
                    <el-form-item label="货品" prop="sampleName">
                        <el-input v-model="ruleForm.sampleName" :disabled="true" />
                    </el-form-item>
                </el-col>
                <el-col :span="3"></el-col>
                <el-col :span="8">
                    <el-form-item label="检测项目" prop="basicItemName">
                        <BasicItemSelector :disabled="true" v-model="ruleForm.basicItemName"
                            :modelValue="ruleForm.basicItemId" @selectChange="selectChange"></BasicItemSelector>
                    </el-form-item>
                </el-col>
            </el-row>
            <el-row :gutter="20">
                ...
                <el-col :span="8">
                    <el-form-item label="进货数量" prop="quantityIn" style="position: reletive">
                        <vxe-input v-model="ruleForm.quantityIn" type="float" :disabled="true" step="10" min="0.01" />
                ...
                <el-col :span="8">
                    <el-form-item label="样品数量" prop="quantitySample" style="position: reletive">
                        <vxe-input v-model="ruleForm.quantitySample" type="float" :disabled="true" step="10"
                            min="0.01" />
        ...
        <div class="border-box">
            ...
            <el-form ref="ruleForm2" :model="ruleForm" label-width="auto">
                <el-row :gutter="20" class="paddingBorder">
                    ...
                    <el-col :span="7">
                        <el-form-item label="初检数据" style="position: reletive">
                            <vxe-input v-if="model === 'view'" v-model="ruleForm.checkData" :disabled="true" />
                            <vxe-input v-else-if="ruleForm.basicItemType === 0" placeholder="请输入"
                                v-model="ruleForm.checkData" :disabled="true" type="float" min="0.01" max="100"
                                step="1.0" />
                            <BasicItemValuesSelector v-else-if="ruleForm.basicItemType === 1"
                                v-model="ruleForm.checkData" :id="ruleForm.basicItemId" :disabled="true">
                    ...
                    <el-col :span="7">
                        <el-form-item label="初检通道">
                            <el-input v-if="model === 'view'" v-model="ruleForm.checkChannel" :disabled="true" />
                            <el-input v-else placeholder="请输入" v-model="ruleForm.checkChannel" :disabled="true" />
                        </el-form-item>
                    </el-col>
                    <el-col :span="7">
                        <el-form-item label="抑制率">
                            <vxe-input v-if="model === 'view'" v-model="ruleForm.checkInhibitionRatio" :disabled="true"
                                type="float" min="0.01" max="100" step="1.0" />
                            <vxe-input v-else type="float" placeholder="请输入" v-model="ruleForm.checkInhibitionRatio"
                                :disabled="true" min="0.01" max="100" step="1.0" />
                            <div class="unit">%</div>
                        </el-form-item>
                    </el-col>
                </el-row>
                ...
                <el-row :gutter="20" class="paddingBorder">
                    ...
                    <el-col :span="7">
                        <el-form-item label="复检数据" style="position: reletive">
                            <vxe-input v-if="model === 'view'" v-model="ruleForm.recheckData" />
                            <vxe-input v-else-if="ruleForm.basicItemType === 0" v-model="ruleForm.recheckData"
                                placeholder="请输入" type="float" min="0.01" step="1.0" />
                            <BasicItemValuesSelector v-else-if="ruleForm.basicItemType === 1"
                                v-model="ruleForm.recheckData" :id="ruleForm.basicItemId"></BasicItemValuesSelector>
                            <div class="unit" v-show="ruleForm.basicItemType === 0">{{ ruleForm.unit }}</div>
                        </el-form-item>
                    </el-col>
                    <el-col :span="7">
                        <el-form-item label="复检通道">
                            <el-input v-if="model === 'view'" v-model="ruleForm.recheckChannel" />
                            <el-input v-else v-model="ruleForm.recheckChannel" placeholder="请输入" />
                        </el-form-item>
                    </el-col>
                    <el-col :span="7">
                        <el-form-item label="抑制率">
                            <vxe-input v-if="model === 'view'" type="float" v-model="ruleForm.recheckInhibitionRatio"
                                min="0.01" max="100" step="1.0" />
                            <vxe-input v-else type="float" v-model="ruleForm.recheckInhibitionRatio" placeholder="请输入"
                                min="0.01" max="100" step="1.0" />
                            <div class="unit">%</div>
                        </el-form-item>
                    </el-col>
                ...
                <el-row :gutter="20" class="paddingBorder">
                    ...
                    <el-col :span="14">
                        <el-form-item label="处理方式">
                            <el-input placeholder="请输入" v-model="ruleForm.wasteMethod" />
                        </el-form-item>
                    </el-col>
                    <el-col :span="7">
                        <el-form-item label="处理数量" style="position: reletive">
                            <el-input v-model="ruleForm.wasteWeight" placeholder="请输入" />
                            <div class="unit unit1">KG</div>
                        </el-form-item>
                    </el-col>
                </el-row>
        ...
        <div class="border-box">
            ...
            <el-form ref="ruleForm5" :model="ruleForm">
                <el-row :gutter="20" class="paddingBorder">
                    ...
                    <el-col :span="21">
                        <el-form-item label=" ">
                            <el-input type="textarea" :autosize="{ minRows: 3, maxRows: 4 }" placeholder="请输入"
...
const { ruleForm, rules, formArr, model } = toRefs(state);

onMounted(() => {
    if (state.model !== 'new') {
        state.ruleForm = _.cloneDeep(props.rowData)
        console.log('弹窗',state.ruleForm);
    }
})
...
function confirm() {
    ...
    proxy.$refs.ruleForm5.validate((valid: any) => {
        console.log(valid);
        if (valid) {
            proxy.$attrs.events.confirm(_.cloneDeep(props.rowData));
        } else {
            return false;
        }
    })
